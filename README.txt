...
Denver -> Phoenix -> Los Angeles N, which is about 3,498 kilometers.  However, if we want to avoid Tampa, then the shortest
route becomes Miami -> Cincinnati -> Kansas City -> Denver -> Phoenix -> Los Angeles N, for a total of 3,567 km.
Now, if we also add Cincinnati to the list, then we would have to drive through Atlanta (Miami -> Atlanta -> Kansas City ->
Denver -> Phoenix -> Los Angeles N), which increases the total distance to 3,719 km.  But if we decide to skip Atlanta
